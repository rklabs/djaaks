"""
Django settings for djaaks project.
...
SECRET_KEY = 'l1daszyxxa=dd@g1+g7nbdm3f!p60a!$w@g&w@4zxx&9c%ov3$'
...
WSGI_APPLICATION = 'djaaks.wsgi.application'
...
# Accessible using http://localhost:8000/static/images/imagename
